...
const de: Translations = {
  ...
  categories: {
    ...
    tent: "Zelte",
    wall: "Wandobjekte",
    wall_decoration: "Wanddeko",
    wired: "Wired",
    wired_effect: "Wired Effekte",
    wired_condition: "Wired Bedingungen",
    wired_trigger: "Wired Trigger",
  ...
  trade: {
    ...
    perItem: "pro Stück",
    credits: "Credits",
    creditsPlaceholder: "Credits / Münzen eingeben...",
  },
  arbitrage: {
...
const en: Translations = {
  ...
  trade: {
    ...
    perItem: "per item",
    credits: "Credits",
    creditsPlaceholder: "Enter credits / coins...",
  },
  arbitrage: {
    title: "Arbitrage Finder",
